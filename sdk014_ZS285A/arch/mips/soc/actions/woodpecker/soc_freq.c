...
void soc_enable_spread_spectrum(void)
{
	sys_write32((1<<17) | (1<<16) | (1<<15) | (1<<12) | (7<<9) | (3<<6) | (9<<0), CORE_PLL_DEBUG);
}

void soc_disable_spread_spectrum(void)
{
...
#ifdef CONFIG_SOC_SPREAD_SPECTRUM
	//soc_disable_spread_spectrum(); /*Woodpecker IC need't disable spread spectrum when setting corepll*/
#endif
