...
#define BT_BR_RESERVE_PKT	1		/* Avoid send data used all pkts */
...
#define CFG_ENABLE_REG_TRACK_CHANGED		1
#else
#define CFG_ENABLE_REG_TRACK_CHANGED		0
#endif
...
const struct bt_inner_value_t bt_inner_value = {
	...
	.avrcp_reg_track_changed = CFG_ENABLE_REG_TRACK_CHANGED,
