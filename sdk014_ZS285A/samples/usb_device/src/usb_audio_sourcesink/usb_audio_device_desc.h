...
#define UAC_DT_TOTAL_LENGTH (UAC_DT_AC_HEADER_LENGTH \
	...
	+ UAC_DT_FEATURE_UNIT_SIZE(CONFIG_USB_AUDIO_DOWNLOAD_CHANNEL_NUM, CONFIG_USB_AUDIO_BCONTROLSIZE) \
	+ UAC_DT_FEATURE_UNIT_SIZE(0, CONFIG_USB_AUDIO_BCONTROLSIZE))
