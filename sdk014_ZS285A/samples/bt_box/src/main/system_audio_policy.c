...
/* unit: 0.1 dB */
const short music_da_table[MAX_AUDIO_VOL_LEVEL] = {
	-600, -400, -360, -320, -280, -240, -210, -180,
	-150, -120, -100,  -80,  -60,  -40,  -20,    0,
};
...
#ifdef CONFIG_USER_MUSIC_EFFECT
extern void user_post_processor_register(void);
#endif
