 ...
 * @return 0 excute successed , others failed
 */
static inline int media_player_set_3d_effect(media_player_t *handle, v3d_effect_t *info)
{
	return media_player_set_parameter(handle, MEDIA_EFFECT_DAE_SET_3D_EFFECT, info, sizeof(*info));
}
