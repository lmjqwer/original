...
/**
 * @brief Set AFH Host Channel Classification
 *
 * @param channel This parameter contains 80 1-bit fields.
 * The nth such field (in the range 0 to 78) contains the value for channel n.
 *
 * return 0: successfull, other: failed.
 */
int bt_manager_set_afh_host_channel(u8_t *channel);
...
/**
 * @brief spp get rfcomm channel
 *
 * This routine get spp used rfcomm channel
 *
 * @param spp_chl channel of spp connect
 *
 * @return 0 Invalid channel, others rfcomm channel
 */
u8_t bt_manager_spp_get_rfcomm_channel(u8_t spp_chl);
