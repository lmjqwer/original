...
int audio_policy_get_increase_threshold(u8_t stream_type, u8_t ext_stream_type);

int audio_policy_get_reduce_threshold(u8_t stream_type, u8_t ext_stream_type);
