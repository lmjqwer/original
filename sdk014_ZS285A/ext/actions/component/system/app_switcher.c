...
#define APP_BTMUSIC_MODE		"btmusic"
#define APP_BTCALL_MODE			"btcall"
#endif
...
#ifdef CONFIG_USER_BT_BACKPLAY_DEBUG
	if ((!strcmp(app_name, APP_BTCALL_MODE)) && !strcmp(APP_BTMUSIC_MODE, app_manager_get_current_app())) {
		aduio_system_btmusic_to_btcall_flag(SAVE_BTCALL_FLAG_DATA, true);
	} else {
