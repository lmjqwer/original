...
typedef void (*stack_storage_cb)(char *key);
...
int stack_storage_init(stack_storage_cb cb);
int stack_storage_deinit(void);
int stack_storage_get_linkkey(struct br_linkkey_info *info, u8_t cnt);
int stack_storage_update_linkkey(struct br_linkkey_info *info, u8_t cnt);
int stack_storage_write_ori_linkkey(bt_addr_t *addr, u8_t *link_key);
void stack_storage_clean_linkkey(void);
