 ...
 */
#define BT_UUID_TDS                       BT_UUID_DECLARE_16(0x1824)
...
/** @def BT_UUID_UDS_AEROBIC_THRESHOLD
 *  @brief UDS Aerobic Threshold
 */
#define BT_UUID_UDS_AEROBIC_THRESHOLD             BT_UUID_DECLARE_16(0x2a7f)
#define BT_UUID_UDS_AEROBIC_THRESHOLD_VAL     0x2a7f
...
/** @def BT_UUID_UDS_HEART_RATE_MAX
 *  @brief UDS Heart Rate Max
 */
#define BT_UUID_UDS_HEART_RATE_MAX             BT_UUID_DECLARE_16(0x2a8d)
#define BT_UUID_UDS_HEART_RATE_MAX_VAL     0x2a8d
/** @def BT_UUID_UDS_HEIGHT
 *  @brief UDS Height
 */
#define BT_UUID_UDS_HEIGHT             BT_UUID_DECLARE_16(0x2a8e)
#define BT_UUID_UDS_HEIGHT_VAL     0x2a8e
/** @def BT_UUID_UDS_MAX_RECOMMENDED_HEART_RATE
 *  @brief UDS Maximum Recommended Heart Rate
 */
#define BT_UUID_UDS_MAX_RECOMMENDED_HEART_RATE             BT_UUID_DECLARE_16(0x2a91)
#define BT_UUID_UDS_MAX_RECOMMENDED_HEART_RATE_VAL     0x2a91
/** @def BT_UUID_UDS_RESTING_HEART_RATE
 *  @brief UDS Resting Heart Rate
 */
#define BT_UUID_UDS_RESTING_HEART_RATE             BT_UUID_DECLARE_16(0x2a92)
#define BT_UUID_UDS_RESTING_HEART_RATE_VAL     0x2a92
/** @def BT_UUID_UDS_VO2_MAX
 *  @brief UDS VO2 Max
 */
#define BT_UUID_UDS_VO2_MAX             BT_UUID_DECLARE_16(0x2a96)
#define BT_UUID_UDS_VO2_MAX_VAL     0x2a96
/** @def BT_UUID_UDS_WEIGHT
 *  @brief UDS Weight
 */
#define BT_UUID_UDS_WEIGHT             BT_UUID_DECLARE_16(0x2a98)
#define BT_UUID_UDS_WEIGHT_VAL     0x2a98
...
/** @def BT_UUID_BMS_BOND_MANAGEMENT_CONTROL_POINT
 *  @brief BMS Bond Management Control Point
 */
#define BT_UUID_BMS_BOND_MANAGEMENT_CONTROL_POINT                BT_UUID_DECLARE_16(0x2aa4)
#define BT_UUID_BMS_BOND_MANAGEMENT_CONTROL_POINT_VAL                   0x2aa4
/** @def BT_UUID_BMS_BOND_MANAGEMENT_FEATURE
 *  @brief BMS Bond Management Feature
 */
#define BT_UUID_BMS_BOND_MANAGEMENT_FEATURE                       BT_UUID_DECLARE_16(0x2aa5)
#define BT_UUID_BMS_BOND_MANAGEMENT_FEATURE_VAL                   0x2aa5
/** @def BT_UUID_TDS_CONTROL_POINT
 *  @brief TDS Control Point
 */
#define BT_UUID_TDS_CONTROL_POINT         BT_UUID_DECLARE_16(0x2abc)
#define BT_UUID_TDS_CONTROL_POINT_VAL     0x2abc
