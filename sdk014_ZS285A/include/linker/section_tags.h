...
#define __hfp_dec_ovl_bss    _NODATA_SECTION(.hfp_dec_ovl_bss)
#define __hfp_enc_ovl_bss    _NODATA_SECTION(.hfp_enc_ovl_bss)
#define __hfp_plc_ovl_bss    _NODATA_SECTION(.hfp_plc_ovl_bss)
#define __hfp_aec_ovl_bss    _NODATA_SECTION(.hfp_aec_ovl_bss)
#define __hfp_pcm_ovl_bss    _NODATA_SECTION(.hfp_pcm_ovl_bss)
#else
