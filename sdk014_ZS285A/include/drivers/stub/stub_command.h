...
#define STUB_CMD_ASET_READ_VOLUME_TABLE_DATA_V3         (0x03a6)
...
/*RETT tool commands*/
#define STUB_CMD_RETT_ACK					(0x07fe)
#define STUB_CMD_RETT_READ_KARAOK_PARAM		(0x0741)
#define STUB_CMD_RETT_READ_UPDATE_INFO_FLAG	(0x0740)
#define STUB_CMD_RETT_READ_STATUS			(0x07ff)
#endif
