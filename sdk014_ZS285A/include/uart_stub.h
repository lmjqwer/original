...
typedef struct
{
    ...
    u32_t  timeout;
    u32_t  debug_mode;
	os_sem  init_recv_sem;
	u8_t	recv_flag;
	os_sem  init_send_sem;
	u8_t	send_flag;
...
extern int uart_session_rw(uart_session_request_t *q);
extern int uart_session_w_only(uart_session_request_t *q);

extern int uart_session_open(uart_session_request_t *q);
extern int uart_session_close(void);
